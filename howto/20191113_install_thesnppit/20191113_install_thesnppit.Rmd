...
It gets more complicated if we want to be able work with the same data from different machines. This requires to get access to the database from different clients running on different machines. This requires a distributed setup over different machines.
...
## Experiments
This section describes the trials and experiments with a local installation. 
